...
<div class="page-main">
	...
	<form:form action="update.do" modelAttribute="workflowVO"
	        id="update_form"  style="margin: 100px 0 0 100px; border:none"
		...
		<%-- 
			...
			<li>
				...
				<form:input path="flow_title" style="width:347.5px; 
				" class="underline"/>				
			...
			<li>
				...
				<input type="text"  name="sign_name" value="${workflowVO.sign_name}" id="sign_name" readonly style="width:300px" class="underline"/>
				<br>
			...
			<li>
				...
				<input type="date" name="flow_start" value="${workflowVO.flow_start}"/>
				-		
				<input type="date" name="flow_end" value="${workflowVO.flow_end}"/>
			...
			<li>
				<input type="hidden" name="flow_state" value="font-weight : bold 진행중"/>
			</li>
